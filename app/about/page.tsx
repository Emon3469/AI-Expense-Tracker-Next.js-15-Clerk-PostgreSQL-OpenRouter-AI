...
import { ArrowBigRightDash, BotMessageSquare, ChartBarBig, MessageSquareMore, Sparkles } from 'lucide-react';
...
const AboutPage = () => {
  return (
    <div className='font-sans bg-gradient-to-br from-gray-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-emerald-900/20 text-gray-800 dark:text-gray-200 transition-all duration-300 min-h-screen'>
      {/* Hero Section */}
      <section className='relative overflow-hidden flex flex-col items-center justify-center text-center py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 bg-gradient-to-br from-emerald-500/10 via-blue-500/5 to-teal-500/10 dark:from-emerald-900/30 dark:via-blue-900/20 dark:to-teal-900/30'>
      ...
      <section className='py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm relative overflow-hidden'>
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-lg md:text-xl text-gray-600 dark:text-gray-400 leading-relaxed max-w-3xl mx-auto'>
            At PennyPilot, we leverage cutting-edge artificial
          ...
          <div className='mt-10 grid grid-cols-1 md:grid-cols-3 gap-6'>
            ...
            <div className='bg-gradient-to-br from-green-50 to-teal-50 dark:from-blue-900/20 dark:to-teal-900/20 p-6 rounded-2xl border border-blue-100 dark:border-blue-800/50'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              ...
              <div className='relative z-10'>
                <div className='w-12 h-12 bg-gradient-to-br from-emerald-500 via-blue-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg mb-6'>
                  <span className='text-white text-xl'><BotMessageSquare /></span>
                </div>
            ...
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              ...
              <div className='relative z-10'>
                <div className='w-12 h-12 bg-gradient-to-br from-blue-500 via-teal-500 to-emerald-500 rounded-xl flex items-center justify-center shadow-lg mb-6'>
                  <span className='text-white text-xl'><Sparkles /></span>
                </div>
                <h3 className='text-xl font-bold mb-4 text-gray-900 dark:text-gray-100'>
            ...
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              ...
              <div className='relative z-10'>
                <div className='w-12 h-12 bg-gradient-to-br from-teal-500 via-emerald-500 to-blue-500 rounded-xl flex items-center justify-center shadow-lg mb-6'>
                  <span className='text-white text-xl'><ChartBarBig /></span>
                </div>
                <h3 className='text-xl font-bold mb-4 text-gray-900 dark:text-gray-100'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            <div className='space-y-6'>
              <p className='text-lg text-gray-600 dark:text-gray-400 leading-relaxed'>
                PennyPilot was born from the vision of creating truly
              ...
              <div className='flex items-center gap-4 pt-4'>
                <div className='flex -space-x-2'>
                  <div className='w-10 h-10 bg-gradient-to-br from-emerald-500 to-blue-500 rounded-full border-2 border-white dark:border-gray-800'></div>
      ...
      <section className='py-20 px-8 bg-gradient-to-br from-gray-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-emerald-900/20 relative overflow-hidden'>
        ...
        <div className='max-w-4xl mx-auto text-center relative z-10'>
          ...
          <h2 className='text-4xl md:text-6xl font-bold mb-6 leading-tight text-gray-900 dark:text-gray-100'>
            ...
            <span className='bg-gradient-to-r from-emerald-600 via-blue-500 to-teal-500 bg-clip-text text-transparent'>
              Financial Future
            </span>
          </h2>
          ...
          <p className='text-xl md:text-2xl mb-10 text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed'>
            ...
            habits with PennyPilot. Start your journey towards smarter
            budgeting today.
          </p>
          ...
          <div className='flex flex-col sm:flex-row gap-6 justify-center items-center'>
            <Link
              href='/sign-up'
              className='group relative overflow-hidden bg-gradient-to-r from-emerald-600 via-blue-500 to-teal-500 hover:from-emerald-700 hover:via-blue-600 hover:to-teal-600 text-white px-8 py-4 rounded-2xl font-bold shadow-2xl hover:shadow-3xl transition-all duration-200 transform hover:-translate-y-0.5'
            >
              <span className='relative z-10 flex items-center gap-2'>
                Get Started Free
                <span className='text-lg'><ArrowBigRightDash /></span>
              </span>
              <div className='absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200'></div>
            </Link>
