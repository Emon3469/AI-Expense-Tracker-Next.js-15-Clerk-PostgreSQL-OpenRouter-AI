...
import { HandPlatter, Tickets, ShoppingCart, Clapperboard, Receipt, Hospital, CircleFadingPlus } from 'lucide-react';
...
const RecordItem = ({ record} : { record : Record}) => {
    ...
    return (
        <li className={`bg-white/60 dark:bg-gray-700/60 backdrop-blur-sm p-4 sm:p-6 rounded-xl shadow-lg border border-gray-100/50 dark:border-gray-600/50 border-l-4 ${getBorderColor(record?.amount)} hover:bg-white/80 dark:hover:bg-gray-700/80 relative min-h-[120px] sm:min-h-[140px] flex flex-col justify-between overflow-visible group`}>
            <button
