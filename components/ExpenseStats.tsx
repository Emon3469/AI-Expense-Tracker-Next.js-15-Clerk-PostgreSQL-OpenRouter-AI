...
import { ArrowBigUpDash, ArrowBigDownDash, ChartColumnBig } from 'lucide-react';
...
const ExpenseStats = async () => {
    try{
        ...
        const { record, dayWithRecords } = userRecordResult;
        const { bestExpense, worstExpense } = rangeResult;

        const validRecord = record || 0;
        const validDays = dayWithRecords && dayWithRecords > 0 ? dayWithRecords : 1;
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl">
                <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                    <div className="w-8 h-8 sm:w-10 bg-gradient-to-br from-emerald-500 via-blue-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg">
                        <span className="text-white text-sm sm:text-lg"><ChartColumnBig /></span>
                    </div>
                    <div>
                        ...
                        <div className="bg-red-50/80 dark:bg-red-900/20 backdrop-blur-sm p-3 sm:p-4 rounded-xl border-l-4 border-l-red-500 hover:bg-red-50 dark:hover:bg-red-900/30">
                            <div className="flex items-center gap-2">
                                ...
                                <div className="flex-1">
                                    <h4 className="font-bold text-gray-900 dark:text-gray-900 text-xs mb-0.5">
                                       Highest
                                    </h4>
                                    <p className="text-lg font-bold text-red-600 dark:text-red-300">
                                       { bestExpense !== undefined ? `$${bestExpense}` : 'No Data Available!'}
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="bg-green-50/80 dark:bg-green-900/20 backdrop-blur-sm p-3 sm:p-4 rounded-xl border-l-4 border-l-green-500 hover:bg-green-50 dark:hover:bg-green-900/30">
                            <div className="flex items-center gap-2">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-lg font-bold text-red-600 dark:text-red-300">
                                       {
                                         worstExpense !== undefined ? `$${worstExpense}` : 'No Data Available!'
                                       }
                                    </p>
                                </div>
                            </div>
        ...
        return (
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl">
                <div className="flex items-center gap-3 mb-6">
                    <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 via-blue-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg">
