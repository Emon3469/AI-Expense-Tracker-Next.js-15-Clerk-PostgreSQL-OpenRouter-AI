...
import { Archive, Sparkles, DollarSign } from 'lucide-react';
        ...
        <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl'>
            <div className='flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6'>
                <div className='w-8 h-8 sm:w-10 bg-gradient-to-br from-emerald-500 via-blue-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg'>
                    <span className='text-white text-sm sm:text-lg'><Archive /></span>
                </div>
                <div>
            ...
            <form
             ...
             >
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-emerald-50/50 dark:from-emerald-900/10 dark:to-blue-900/10 rounded-xl border border-emerald-100/50 dark:border-emerald-800/50'>
                        ...
                        <div className='relative'>
                            <input
                             ...
                             <button
                              ...
                              className='absolute right-2 top-1/2 -translate-y-1.5 w-7 h-7 sm:w-8 sm:h-7 bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-600 hover:to-blue-600 disabled:from-gray-600 disabled:to-gray-300 text-white rounded-lg text-xs font-medium flex items-center justify-center shadow-lg hover:shadow-xl disabled:shadow-none transition-all duration-200'
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-emerald-50/50 dark:from-emerald-900/10 dark:to-blue-900/10 rounded-xl border border-emerald-100/50 dark:border-emerald-800/50'>
                    <div className='space-y-1.5'>
                        <label className='flex items-center gap-2 text-xs font-semibold text-gray-700 dark:text-gray-300 tracking-wide'>
                           ...
                           <span className='text-xs text-gray-400 dark:text-gray-500 ml-2 font-normal hidden sm:inline'>
                               Use the <Sparkles /> button above for AI suggestions
                           </span>
                        </label>
                        <select
                            id='category'
                        ...
                        >
                            ...
                            <option value='Others' className='text-gray-900 dark:text-gray-100'>
                                ➕ Other
                            </option>
                        </select>
                    </div>
                    <div className='space-y-1.5'>
                        ...
                        <div className='relative'>
                            <span className='absolute right-2 top-1/2 -translate-y-1.5 text-gray-500 dark:text-gray-400 font-normal hidden sm:inline'>
                               <DollarSign />
                            </span>
                            <input
                             type='number'
            ...
            {
                alertMessage && (
                    <div className={`mt-4 p-3 rounded-xl border-l-4 backdrop-blur-sm ${alertType === 'success' ? 'bg-green-50/80 dark:bg-green-900/20 border-l-green-500 text-green-800 dark:text-green-200' : 'bg-red-50/80 dark:bg-red-900/20 border-l-red-500 text-red-800 dark:text-red-200'}`}>
